 ...
 * @author andreas
 */
@WebService(serviceName = "TicketBooking", portName = "TicketBookingPort"/*, endpointInterface = "pws.hw2.TicketBookingOld", targetNamespace = "http://hw2.pws/", wsdlLocation = "WEB-INF/wsdl/TicketBooking/TicketBooking.wsdl"*/)
public class TicketBookingOld {
